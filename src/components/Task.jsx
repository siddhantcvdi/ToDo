...
function Task({ task, delTask, doneTask }) {
    return (
        ...
        >
            ...
            <div className={`flex items-center justify-center rounded-md bg-orange-100 ${task.dueDate?'block':'hidden'} w-[20%] overflow-scroll scrollbar-none ${task?.done ? 'line-through font-thin text-gray-500' : ''} text-[10px]`}>
                {task?.dueDate}
            </div>
